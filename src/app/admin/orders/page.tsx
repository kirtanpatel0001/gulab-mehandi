          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-[#FDFBF7] border-b border-[#1B342B]/5">
                <th className="px-8 py-6 text-[10px] uppercase tracking-widest text-[#1B342B]/50 font-bold">Order ID</th>
                <th className="px-8 py-6 text-[10px] uppercase tracking-widest text-[#1B342B]/50 font-bold">Customer</th>
                <th className="px-8 py-6 text-[10px] uppercase tracking-widest text-[#1B342B]/50 font-bold">Order Date</th>
                <th className="px-8 py-6 text-[10px] uppercase tracking-widest text-[#1B342B]/50 font-bold">Total</th>
                <th className="px-8 py-6 text-[10px] uppercase tracking-widest text-[#1B342B]/50 font-bold">Status</th>
            ...
            <tbody>
              {loading ? (
                <tr>
                  <td colSpan={6} className="p-20 text-center text-[#A67C52] text-xs uppercase tracking-widest animate-pulse font-bold">Loading Orders...</td>
                </tr>
              ) : orders.length === 0 ? (
                <tr>
                  <td colSpan={6} className="p-20 text-center text-[#1B342B]/40 italic text-sm">No orders found.</td>
                </tr>
              ) : (
                orders.map((o, index) => (
