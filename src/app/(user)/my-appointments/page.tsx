...
export default function MyAppointmentsPage() {
  ...
  const handleOpenAppt = (appt: any) => {
    ...
    setTimeout(() => setIsInviteOpen(true), 500);
  };
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] py-20 px-6">
      <div className="max-w-4xl mx-auto">
              ...
              >
                ...
                <div className="border-t border-[#1B342B]/5 pt-4 mt-2">
                  <p className="text-[10px] text-[#A67C52] font-bold uppercase tracking-widest group-hover:text-[#1B342B] transition-colors flex items-center">
                    Open Invitation
                    <svg className="w-3 h-3 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" /></svg>
                  </p>
                </div>
              </div>
            ))}
        ...
        {/* 3D Gatefold Invitation Modal */}
        {selectedAppt && (
          <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4 backdrop-blur-md" onClick={closeModal}>
            <div className="relative w-full max-w-sm h-[450px] mx-auto" style={{ perspective: '2000px' }} onClick={(e) => e.stopPropagation()}>
              ...
              {/* Left door */}
              <div
                className="absolute top-0 left-0 w-1/2 h-full bg-[#1B342B] origin-left border-r border-[#A67C52]/40 shadow-2xl z-20"
                style={{
