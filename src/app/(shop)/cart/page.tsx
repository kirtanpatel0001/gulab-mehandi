        ...
        {cartItems.length === 0 ? (
          ...
          <div className="flex flex-col lg:flex-row gap-16 xl:gap-24 items-start">
            ...
            <div className="w-full lg:w-[40%] bg-[#1B342B]/5 p-8 md:p-12 lg:sticky lg:top-32">
              ...
              <Link href="/checkout" className="block w-full bg-[#1B342B] text-[#FDFBF7] py-5 text-center text-[10px] uppercase tracking-[0.25em] font-bold hover:bg-[#A67C52] transition-colors duration-300 shadow-xl mb-4">
                Secure Checkout
              </Link>
