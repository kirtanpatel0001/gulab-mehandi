        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 mb-16">
          ...
          <div className="flex flex-col space-y-6 lg:pr-8">
            ...
            <div className="flex space-x-5 pt-4">
              {/* Instagram */}
              <a href="https://www.instagram.com/gulab_mehandi?igsh=djIyaDJoZWt6aThn" className="text-[#FDFBF7]/70   hover:text-[#A67C52] hover:-translate-y-1 transition-all duration-300">
              ...
              {/* Facebook */}
              <a href="#" className="text-[#FDFBF7]/70 hover:text-[#A67C52] hover:-translate-y-1 transition-all duration-300">
